      ...
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row justify-between items-center'>
          ...
          <div className='flex flex-col xl:flex-row gap-y-4 gap-x-[30px]'>
            ...
            <button className='btn btn-quaternary flex items-center gap-x-[20px]' data-aos='fade-up' data-aos-delay='400'>{btnText2} <BsArrowRight className='text-2xl text-accent-primary transition group-hover:text-white' /></button>
          </div>
        </div>
      </div>
    </section>
