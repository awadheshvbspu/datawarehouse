...
export default function About() {
  ...
  return (
    <section className='my-[30px] xl:mt-[100px]' data-aos='fade-up' data-aos-offset='400'>
    ...
    <p className='max-w-[474px] mx-auto xl:mx-0' data-aos='fade-up' data-aos-delay='300'>{subtitle}</p>
    </div>
    </div>
    </div>
    </section>
